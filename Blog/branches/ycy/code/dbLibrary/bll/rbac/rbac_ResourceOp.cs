...
namespace db.bll
{
    ...
    public class rbac_ResourceOp
    {
        ...
        public static string batchSave(db.dbEntities dc)
        {
            ...
            dic.Add("rowID", rui.requestHelper.getList("detail.rowID"));
            dic.Add("operationCode", rui.requestHelper.getList("detail.operationCode"));
            dic.Add("operationName", rui.requestHelper.getList("detail.operationName"));
