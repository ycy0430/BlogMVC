...
namespace db.bll
{
    ...
    public class sbs_Org
    {
        ...
        /// <returns></returns>
        public static bool syncData(string selectedinExpression, ref string message)
        {
            bool result = rui.syncHelper.syncData("sbs_Org", selectedinExpression, ref message);
            return result;
        }
    }
}
