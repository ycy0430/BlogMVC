...
namespace web.Areas.admin.Controllers
{
    ...
    public class rbac_ResourceController : baseController
    {
        ...
        public ActionResult Insert(string moduleCode)
        {
            ...
            model.operationCodeList = db.bll.rbac_Operation.bindDdl();
            return View(model);
        }
        ...
        public ActionResult Update(string rowID)
        {
            db.rbac_Resource model = db.bll.rbac_Resource.getEntryByRowID(rowID, dc);
            model.operationCodeList = db.bll.rbac_Operation.bindDdl();
            rui.listHelper.setListSelected(model.operationCodeList, model.haveOperations);
            return View(model);
        }
        ...
        public JsonResult batchSave()
        {
            ...
            try
            {
                ...
                dic.Add("resourceCode", rui.requestHelper.getList("detail.resourceCode"));
                dic.Add("showOrder", rui.requestHelper.getList("detail.showOrder"));
                dic.Add("pageWidth", rui.requestHelper.getList("detail.pageWidth"));
                dic.Add("pagerCount", rui.requestHelper.getList("detail.pagerCount"));
