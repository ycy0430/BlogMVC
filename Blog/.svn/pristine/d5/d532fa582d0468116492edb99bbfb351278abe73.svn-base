...
namespace db.view
{
    ...
    public class pageConfig : rui.pagerBase
    {
        ...
        {         
            ...
            //搜索语句
            string querySql = @" SELECT rowID, fieldCode,fieldName,fieldName as CFieldName,isShow,showOrder,isOrder,colWidth,isResize,fixedValue,alignType FROM dbo.sys_Column WHERE isShow='1' ";
