...
namespace web.Areas.admin.Controllers
{
    ...
    public class af_AuditPostUserController : baseController
    {
        ...
        public JsonResult batchSave()
        {
            ...
            try
            {
                List<string> rowIDList = rui.requestHelper.getList("detail.rowID");
                List<string> showValueList = rui.requestHelper.getList("detail.showValue");
                List<string> isDeptPostList = rui.requestHelper.getList("detail.isDeptPost");
                List<string> deptCodeList = rui.requestHelper.getList("detail.deptCode");
